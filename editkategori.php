...
<form class="cbp-mc-form" action="editkat1.php" name="editkategori" id="editkategori" method="post">
    <div class="head">
        <h1 align="center">Tambah/Edit Kategori</h1> 
        <h3 align="center" id="info"></h3>
    </div>
    <?php $p = getKategorie($_GET['id']); ?>
    <div class="cbp-mc-column">
        <input type="hidden" name="id" value="<?php echo  $p['id']?>">
        <label for="id_barang">Id_barang</label>
        <input type="text" id="id_barang" name="id_barang" placeholder="ID" value="<?php echo  $p['id_kategori']?>">
        <label for="gagdet">Nama Barang</label>
        <input type="text" id="nama_barang" name="nama_barang" placeholder="Nama Barang" value="<?php echo  $p['kategori']?>">
